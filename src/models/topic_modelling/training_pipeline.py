...
def run_training_pipeline(model_choice, pre_processed_df):
    ...
    ----------
    model_choice : str
        The topic modeling algorithm to use, options are: "lda", "lsa", "nmf", "bertopic".
    pre_processed_df : pd.DataFrame
        The pre-processed input data to train the topic modeling algorithm on.

    Returns
    -------
    topics_dict : dict
        A dictionary containing the topics generated by the specified topic modeling algorithm.
...
def topics_dict_to_df(model_choice, topics_dict):
    ...
    ----------
    model_choice : str
        The topic modeling algorithm used to generate the topics_dict.
    topics_dict : dict
        A dictionary containing the topics generated by the specified topic modeling algorithm.
    ...
    pivoted_df : pd.DataFrame
        A DataFrame with the topic_id, words and corresponding scores for each topic.
    """
