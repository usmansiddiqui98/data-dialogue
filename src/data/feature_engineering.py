...
# TODO: add a class for these util methods that act on each sentence
...
class FeatureEngineering:
    ...
    def add_features(self):
        ...
        new_df = FeatureEngineering.pos_tag_count(new_df)
        new_df = FeatureEngineering.tokenized_untokenized_count(new_df)
